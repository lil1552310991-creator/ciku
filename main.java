    ...
    act.runOnUiThread(new Runnable() {
        public void run() {
            try {
                ...
                title.setText("Q群猎魔大杂烩 v4.4.3"); title.setTextSize(17);
...
void main() {
    ...
    log("Q群猎魔大杂烩已启动 v4.4.3 | 触发:" + triggerCount + " | 目标:" + gTargets.size() + "人 | 词库:" + (gPreTextPool.size() + gPostTextPool.size() + gPreImgPool.size() + gPostImgPool.size()) + "条");
    // 词库未同步提示
